...
class MovieSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Movie
        fields = ('id', 'name', 'duration', 'rental_start_date', 'rental_finish_date', 'sales_company', )
...
class MovieDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Movie
        fields = ('id', 'name', 'duration', 'rental_start_date', 'rental_finish_date', 'sales_company', 'movie_session')
...
class SaloonDetailSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Saloon
        fields = ('id', 'name', 'count_place', 'description', 'number_of_rows', 'number_of_places', 'saloon_name')
...
class SeansSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Seans
        fields = ('id', 'saloon', 'date', 'time', 'movie', )
...
class SectorSaloonSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = SectorSaloon
        fields = ('saloon', 'name', 'description', )

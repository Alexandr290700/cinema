...
class Movie(models.Model):
    ...
    sales_company = models.CharField(
        max_length=255, verbose_name="Кинокомпания"
    )
...
class Places(models.Model):
    saloon = models.ForeignKey(
        Saloon, on_delete=models.CASCADE, verbose_name="Зал"
    )
...
class PriceForTickets(models.Model):
    seanse = models.ForeignKey(
        Seans, on_delete=models.CASCADE, verbose_name="Сеансы"
    )
    sector = models.ForeignKey(
        SectorSaloon, on_delete=models.CASCADE, verbose_name="Сектор"
    )
...
class Tickets(models.Model):
    ...
    seanses = models.ForeignKey(
        Seans, on_delete=models.CASCADE, verbose_name="Сеанс"
    )
    places = models.ForeignKey(
        Places, on_delete=models.CASCADE, verbose_name="Место"
    )
...
class MovingTickets(models.Model):
    ...
    ticket = models.ForeignKey(
        Tickets, on_delete=models.CASCADE, verbose_name="Номер билета"
    )
